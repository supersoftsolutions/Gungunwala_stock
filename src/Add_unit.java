...
public class Add_unit extends JInternalFrame {
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try
				{
                    ...
                    {
                    	String query="insert into Unit(Unit) VALUES ('"+unit.getText()+"')";
