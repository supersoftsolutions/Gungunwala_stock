...
public class Add_bom extends JInternalFrame {
	...
	public Add_bom() {
        ...
        JLabel lblWholesaleBill = new JLabel("Add BOM");
        ...
        table.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent arg0) {
                ...
                try{
                    String querytable = "select * from B_temp where ID='"+id+"'";
                    PreparedStatement pmttable = connection.prepareStatement(querytable);
                    ResultSet rstable = pmttable.executeQuery();
                    while(rstable.next())
                    {
        ...
        getContentPane().add(lblQuantity);
            ...
            try{
                String querydetais="delete from B_temp";
                PreparedStatement pmtdetails = connection.prepareStatement(querydetais);
                pmtdetails.executeUpdate();
                pmtdetails.close();
                ...
                if(arg0.getKeyCode()==KeyEvent.VK_ENTER){
                    ...
                    try
                    {
                        ...
                        else
                        {
                            ...
                            {
                                int c=0;
                                String query2="select * from B_temp";
                                ...
                                {
                                    int id=0;
                                    String query3="select * from B_temp";
                                ...
                                String query1="insert into B_temp (ID,Product, Qty) VALUES ('"+i+"','"+pro.getSelectedItem().toString()+"','"+quantity.getText()+"')";
                                PreparedStatement pmt1 = connection.prepareStatement(query1);
                                pmt1.executeUpdate();
                                pmt1.close();
                                
                                String query = "select * from B_temp";
                                PreparedStatement pmt = connection.prepareStatement(query);
                                ResultSet rs = pmt.executeQuery();
                                ...
                                String query1="update B_temp set Qty = '"+quantity.getText()+"' where ID = '"+id+"'";
                                PreparedStatement pmt1 = connection.prepareStatement(query1);
                                pmt1.executeUpdate();
                                pmt1.close();
        ...
        button.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                ...
                try
                {
                 ...
                 {
                     String query0 = "select * from B_temp";
                     ...
                     String query1="insert into BOM (Name) VALUES ('"+name.getText()+"')";
                     ...
                     {
                         String querydetais="insert into BOM_Detail (S_id, Product, Qty) VALUES ('"+id+"','"+product.get(i)+"',"+qty.get(i)+")";
                         PreparedStatement pmtdetails = connection.prepareStatement(querydetais);
                         pmtdetails.executeUpdate();
                         pmtdetails.close();
                     }
                     
                     Add_bom b = new Add_bom();
