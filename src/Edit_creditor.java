...
public class Edit_creditor extends JInternalFrame {
	...
	public Edit_creditor() {
		...
		JLabel lblEditCreditor = new JLabel("Edit Creditor");
		...
		creditor = new JTextField();
		creditor.setEditable(false);
		creditor.setColumns(10);
		creditor.setBounds(135, 57, 269, 28);
			...
			public void actionPerformed(ActionEvent arg0) {
				try
				{
					...
					else
					{
						try
						{
							String query1="update Purchase set Creditor='"+name.getText()+"' where Creditor='"+creditor.getText()+"'";
						...
						try
						{
							String query1="update PO set Name='"+name.getText()+"' where Name='"+creditor.getText()+"'";
	                        PreparedStatement pmt1 = connection.prepareStatement(query1);
	                        pmt1.executeUpdate();
	                        pmt1.close();	
						}
						...
						try
						{
							String query1="update Payment set Name='"+name.getText()+"' where Name='"+creditor.getText()+"'";
	                        PreparedStatement pmt1 = connection.prepareStatement(query1);
	                        pmt1.executeUpdate();
	                        pmt1.close();	
						}
						...
						String query1="update Crediter_OpeningBalance set Name='"+name.getText()+"' where Name='"+creditor.getText()+"'";
                        PreparedStatement pmt1 = connection.prepareStatement(query1);
                        pmt1.executeUpdate();
                        pmt1.close();
                        
		            	String query="update Creditor set Name='"+name.getText()+"',Address1='"+address1.getText()+"',Address2='"+address2.getText()+"',Address3='"+address3.getText()+"',Country='"+country.getSelectedItem().toString()+"',State='"+state.getSelectedItem().toString()+"',City='"+city.getSelectedItem().toString()+"',Mobile='"+mobile.getText()+"',Contact_person='"+contact_person.getText()+"' where ID='"+id+"'";
		...
		try
		{
			String query5 = "select * from Creditor_id";
            PreparedStatement pmt5 = connection.prepareStatement(query5);
            ResultSet rs5 = pmt5.executeQuery();
		    while(rs5.next())
		    {
