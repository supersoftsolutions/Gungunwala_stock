...
public class Detail_staff_issue extends JInternalFrame {
	public JLabel bill;
    public int id1; 
    public JTable table;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Detail_staff_issue frame = new Detail_staff_issue();
