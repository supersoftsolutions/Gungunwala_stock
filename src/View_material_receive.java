...
public class View_material_receive extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					View_material_receive frame = new View_material_receive();
	...
	public View_material_receive() {
        ...
        scrollPane.setBounds(0, 88, 758, 343);
            ...
            public void actionPerformed(ActionEvent arg0) {
                try
                {
					...
					if(dialogResult == JOptionPane.YES_OPTION){
	                    ...
	                    String date =null;
	                    String name = null;
	                    String query2 = "Select * from Receive where ID="+id;
	                    ...
	                    String query = "delete from Receive where ID="+id;
	                    PreparedStatement pmt = connection.prepareStatement(query);
	                    pmt.executeUpdate();
	                    pmt.close();
	                    
	                                               
	            		String query4 = "UPDATE Stock set Stock =Stock-"+t+" where product='"+name+"'";
	                    PreparedStatement pmt4 = connection.prepareStatement(query4);
	                    pmt4.executeUpdate();
	                    pmt4.close();
	                    
	                    String query41 = "UPDATE Product set Stock =Stock-"+t+" where product='"+name+"'";
                ...
                View_material_receive b = new View_material_receive();
        ...
        textField.addKeyListener(new KeyAdapter() {
            ...
            public void keyTyped(KeyEvent arg0) {
                try {
                    ...
                    // pull data from the database 
                    String query = "select * from Receive where Product like '%"+textField.getText()+"%' or ID like '%"+textField.getText()+"%' or Date like '%"+textField.getText()+"%' or Qty like '%"+textField.getText()+"%'";
                    PreparedStatement pmt = connection.prepareStatement(query);
                    ResultSet rs = pmt.executeQuery();
                    table.setModel(DbUtils.resultSetToTableModel(rs));
                    pmt.close();
        ...
        JLabel lblMaterialReceive = new JLabel("Material Receive");
