...
public class Add_material_receive extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Add_material_receive frame = new Add_material_receive();
	...
	public Add_material_receive() {
        ...
        JLabel lblWholesaleBill = new JLabel("Add Recive");
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                try
                {
                    ...
                    else
                    {
                       ...
                       String query1="insert into Receive ( Date, Product, Qty) VALUES ('"+((JTextField)date.getDateEditor().getUiComponent()).getText()+"','"+product.getSelectedItem().toString()+"','"+qty.getText()+"')";
                      ...
                      Add_material_receive b = new Add_material_receive();
