...
public class Detail_creditor extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Detail_creditor frame = new Detail_creditor();
	...
	public Detail_creditor() {
        ...
        int h = (int)(height);
        setClosable(true);
		setBounds((w-450)/2, (h-551)/2, 450, 484);
...
final Connection connection = Databaseconnection.connection2();
		...
		try
		{
		    ...
		    while(rs51.next())
		    {
		    	...
		    	balance.setText(rs51.getString("Balance"));
            }
		    rs51.close();
		    pmt51.close();
		}
