...
public class Edit_returnable_material extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Edit_returnable_material frame = new Edit_returnable_material();
	 ...
	 * Create the frame.
	 */
	public Edit_returnable_material() {
		getRootPane().getInputMap(JComponent.WHEN_IN_FOCUSED_WINDOW).put(
					 ...
					 try
	                    {
	                        ...
	                        else
	                        {
	                            ...
	                            {
	                                int c=0;
	                                String query2="select * from Returnable_temp1";
	                                ...
	                                {
	                                    int id=0;
	                                    String query3="select * from Returnable_temp1";
	                                ...
	                                String query1="insert into Returnable_temp1 (ID,Product, Qty,Return_Date,Type) VALUES ('"+i+"','"+product.getSelectedItem().toString()+"',"+qty.getText()+",'"+((JTextField)dateChooser_1.getDateEditor().getUiComponent()).getText()+"','"+type.getText()+"')";
	                                PreparedStatement pmt1 = connection.prepareStatement(query1);
	                                pmt1.executeUpdate();
	                                pmt1.close();
	                                
	                                
	                                String query = "select * from Returnable_temp1";
	                                PreparedStatement pmt = connection.prepareStatement(query);
	                                ResultSet rs = pmt.executeQuery();
	                            ...
	                            else
	                            {
	                                ...
	                                String query1="update Returnable_temp1 set Qty='"+qty.getText()+"',Type='"+type.getText()+"' where ID = '"+id+"'";
	                                PreparedStatement pmt1 = connection.prepareStatement(query1);
	                                pmt1.executeUpdate();
	                                pmt1.close();
			...
			button_1.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					try{
                        ...
                        String querydetais="delete from Returnable_temp1 where ID='"+id+"'";
                        PreparedStatement pmtdetails = connection.prepareStatement(querydetais);
                        pmtdetails.executeUpdate();
                        pmtdetails.close();
                        
                        
                        String querytable = "select * from Returnable_temp1";
			...
			table.addMouseListener(new MouseAdapter() {
	            public void mouseClicked(MouseEvent arg0) {
		            ...
		            try
		            {
		            	String query13 = "select * from Returnable_temp1 where ID='"+id+"'";
				...
				public void actionPerformed(ActionEvent arg0) {
					   ...
					   ArrayList<String> product = new ArrayList<String>();
		                ...
		                try
		                {
		                   ...
		                   {
		                       String query0 = "select * from Returnable_temp1";
		                       ...
		                       String query1c="update Returnable set Client_name='"+client_name.getText()+"',Name='"+name.getText()+"',Amount='"+amount.getText()+"',Date='"+((JTextField)dateChooser.getDateEditor().getUiComponent()).getText()+"' where ID='"+id99+"'";
		                       PreparedStatement pmt1c = connection.prepareStatement(query1c);
		                       pmt1c.executeUpdate();
		                       pmt1c.close();
		                       ...
		                       String query1="update Returnable set Client_name='"+client_name.getText()+"',Name='"+name.getText()+"',Amount='"+amount.getText()+"',Date='"+((JTextField)dateChooser.getDateEditor().getUiComponent()).getText()+"' where ID='"+id99+"'";
		                       PreparedStatement pmt1 = connection.prepareStatement(query1);
		                       pmt1.executeUpdate();
		                       pmt1.close();
		                       ...
		                       {
		                           String querydetais="insert into Returnable_Details (S_id, Product, Qty,Return_Date,Type) VALUES ('"+id99+"','"+product.get(i)+"',"+qty.get(i)+",'"+dateChooser_1.get(i)+"','"+type.get(i)+"')";
		                           PreparedStatement pmtdetails = connection.prepareStatement(querydetais);
		                           pmtdetails.executeUpdate();
		                           pmtdetails.close();
	                           }
		                       
		                       String querydetais="delete from Returnable_temp1";
		                       PreparedStatement pmtdetails = connection.prepareStatement(querydetais);
		                       pmtdetails.executeUpdate();
		                       pmtdetails.close();
				...
				catch(Exception ae)
				{
					ae.printStackTrace();
		                ...
		                try{
			                ...
			                String query3="select * from Returnable_id";
			                PreparedStatement pmt3 = connection.prepareStatement(query3);
			                ResultSet rs3 = pmt3.executeQuery();
			                while(rs3.next())
			                {
			                ...
			                String query31="select * from Returnable";
			                ...
			                while(rs31.next())
			                {
			                    ...
			                    amount.setText(rs31.getString("Amount"));
			                ...
			                String query0 = "select * from Returnable_Details where S_id='"+id99+"'";
		                       PreparedStatement pmt0 = connection.prepareStatement(query0);
		                       ...
		                       for(int i=0; i<product.size();i++)
		                       {
		                           String querydetais1="insert into Returnable_temp1 (ID, Product, Qty,Return_Date,Type) VALUES ('"+(i+1)+"','"+product.get(i)+"',"+qty.get(i)+",'"+date.get(i)+"','"+type.get(i)+"')";
