...
public class Add_client extends JInternalFrame {
	...
	public Add_client() {
        ...
        int h = (int)(height);
        setClosable(true);
		setBounds((w-450)/2, (h-466)/2, 450, 466);
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try
				{
					...
					{
						String query="insert into Client (Name,Address1,Address2,Address3,Country,State,City,Mobile,Contact_person) VALUES ('"+name.getText()+"','"+address1.getText()+"','"+address2.getText()+"','"+address3.getText()+"','"+country.getSelectedItem().toString()+"','"+state.getSelectedItem().toString()+"','"+city.getSelectedItem().toString()+"','"+mobile.getText()+"','"+contact_person.getText()+"')";
		...
		button.setBounds(145, 389, 89, 28);
		...
		lblClient.setBounds(132, 21, 209, 25);
